 ...
 * 
 * You can still see the Library Connected to this class @EmployeeModel in my Config but 
...
public class Employee {
    ...
    public Employee(int id, String fName, String lName, String phoneNumber, String emergencyNumber, String email) {
        this.id = id;
        this.fName = fName;
        this.lName = lName;
